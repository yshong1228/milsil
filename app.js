...
function invalidateMergedGames(){_mergedGamesCache=null;_mergedGamesByName=null;}
...
function invalidatePlayedByMember(){_playedByMember=null;}
...
function switchTab(tab){
  ['board','records','members'].forEach(function(t){
